...
namespace Models\Department.php\Models;

use Utils\Logger;

/**
 * Modelo para los departamentos de la organizaciÃ³n
 * 
 * Gestiona la informaciÃ³n de departamentos, sus estadÃ­sticas de reclutamiento,
 * pipeline de candidatos y mÃ©tricas de rendimiento organizacional.
 * 
 * Funcionalidades principales:
 * - GestiÃ³n de departamentos con informaciÃ³n bÃ¡sica y presupuestaria
 * - Pipeline de reclutamiento por departamento usando vistas optimizadas
 * - EstadÃ­sticas de candidatos y aplicaciones por departamento
...
class Department extends BaseModel
{
     ...
     * âŒ Campos removidos: ['description', 'head_id', 'status', 'budget', 'location']
     * ðŸ“Š Total campos fillable: 1
     * 
    ...
    /**
     * Campos ocultos por seguridad (informaciÃ³n sensible)
     */
    protected array $hidden = [
        'budget'  // InformaciÃ³n financiera sensible
    ];
    ...
    /**
     * MÃ‰TODOS DE VISTAS - Pipeline y estadÃ­sticas departamentales
     */

    /**
     * Obtener pipeline de reclutamiento por departamento
     * 
     * Utiliza la vista vw_pipeline_department para obtener estadÃ­sticas
     * completas del pipeline de reclutamiento por departamento.
     * 
     * @param string|null $departmentId ID especÃ­fico del departamento (opcional)
     ...
     * 
     * @throws \InvalidArgumentException Si department_id no es vÃ¡lido
    ...
    /**
     * Obtener estadÃ­sticas de rendimiento por departamento
     * 
     * Calcula mÃ©tricas agregadas de rendimiento departamental incluyendo
     * totales de candidatos, aplicaciones, tasas de conversiÃ³n y promedios.
     * 
     * @param string $departmentId ID del departamento
     * @param bool $useCache Usar cache para optimizar consultas
     * @return array MÃ©tricas de rendimiento del departamento
     */
     ...
     * 
     * @param array $filters Filtros opcionales por estado, ubicaciÃ³n, etc.
     * @param bool $useCache Usar cache para consultas optimizadas
     * @return array Lista de departamentos con mÃ©tricas de carga
     */
     ...
     * 
     * Recupera candidatos asignados a un departamento especÃ­fico con
     * capacidad de filtrado por estado, ubicaciÃ³n, habilidades, etc.
     * 
     * @param string $departmentId ID del departamento
     * @param array $filters Filtros adicionales (status, location, skills, etc.)
     * @param int $page PÃ¡gina para paginaciÃ³n
     * @param int $limit LÃ­mite de resultados por pÃ¡gina
    ...
    /**
     * MÃ‰TODOS DE GESTIÃ“N ORGANIZACIONAL
     */

    /**
     * Obtener jerarquÃ­a de departamentos con sus subordinados
     * 
     * @param string|null $parentId ID del departamento padre (null para raÃ­z)
     * @return array Ãrbol jerÃ¡rquico de departamentos
     */
     ...
     * @return array Resumen con mÃ©tricas clave de todos los departamentos
     */
     ...
     * Mantener funcionalidad especÃ­fica existente del modelo original
     */
     ...
     * @param array $filters Filtros de bÃºsqueda
     * @return int NÃºmero total de departments
     */
    ...
    /**
     * Validar datos especÃ­ficos de departments
    ...
    private function validateDepartmentData(array $data, $id = null): void
    {
        ...
        // Validar que el nombre no estÃ© duplicado (si es creaciÃ³n o actualizaciÃ³n con nombre diferente)
        if (isset($data['name'])) {
    ...
    /**
     * Invalidar cache especÃ­fico de departments
     */
