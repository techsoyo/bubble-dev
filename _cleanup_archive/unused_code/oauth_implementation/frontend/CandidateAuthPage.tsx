  ...
  const handleProcessCV = async () => {
    ...
    try {
      ...
      if (response.ok && json?.success && json.data) {
        ...
        setRegisterForm(prev => ({ ...prev, cvData: json.data }));
  ...
  return (
    <div className="min-h-screen bg-transparent flex items-center justify-center p-4">
      <div className="w-full max-w-md relative">
        ...
        <div className={`transition-all duration-1000 ease-out transform ${isLogin ? 'opacity-100 scale-100 translate-y-0 rotate-0 blur-0 delay-150' : 'opacity-0 scale-98 translate-y-2 rotate-1 blur-sm pointer-events-none absolute inset-0'}`} style={{
