    ...
    switch ($path) {
        ...
        case '/api/auth/register':
            if ($request_method === 'POST') {
                ...
                Res::error('MÃ©todo no permitido', null, 405);
            }
            break;
        ...
        case '/api/auth/session':
            ...
            break;
        // âŒ ENDPOINT DEPRECADO
        case '/api/auth/login':
            http_response_code(410);
            Res::error('Este endpoint estÃ¡ deprecado. Los candidatos deben usar /api/auth/register', null, 410);
            break;
