...
class TranslationService
{
    ...
    private static $translations = [
        'es' => [
            ...
            'coincidencia_excelente' => 'El candidato muestra una excelente coincidencia con la oferta de trabajo. Sus habilidades principales (%s) se alinean perfectamente con los requisitos del puesto. Su experiencia en %s proporciona el conocimiento necesario para desempeí±ar las funciones requeridas.',
            'coincidencia_buena' => 'El candidato muestra una buena coincidencia con la oferta de trabajo, aunque hay í¡reas de mejora. Tiene experiencia relevante y algunas de las habilidades clave requeridas, pero podrí­a necesitar formación adicional en algunos aspectos especí­ficos del puesto.',
            ...
            'el_sector' => 'el sector',
            'habilidades_especificas' => 'habilidades especí­ficas'
        ],
        'en' => [
            // JobMatchingService
     ...
     * @param array $params Parí¡metros para interpolación (opcional)
    ...
    public static function translate($key, $params = [])
    {
        ...
        if (isset(self::$translations[self::$currentLanguage][$key])) {
            ...
            // Aplicar parí¡metros si existen
            if (!empty($params)) {
