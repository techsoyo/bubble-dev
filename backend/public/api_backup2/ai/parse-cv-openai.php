 ...
 * Ahora usa OpenAI para extraer informaciÃ³n de archivos PDF y DOCX.
 *
...
try {
    ...
    if (!isset($_FILES['cv_file'])) {
        ...
        echo json_encode(['error' => 'No se encontrÃ³ el archivo CV']);
        exit;
    }
    ...
    try {
        if ($file['type'] === 'application/pdf') {
            ...
            // Para archivos DOCX, por ahora usaremos el mismo mÃ©todo
            // En futuro se puede agregar soporte especÃ­fico para DOCX
            $extractedText = $pdfExtractorService->extractText($cvPath);
        }
    } catch (\Exception $e) {
        http_response_code(500);
