...
// Consultar en la BD si existe y tiene rol vÃ¡lido
require_once __DIR__ . '/../../config/db.php'; // tu conexiÃ³n
...
// Crear token de sesiÃ³n para API
