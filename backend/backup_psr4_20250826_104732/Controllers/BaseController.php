...
namespace Controllers\BaseController.php\Controllers;
...
abstract class BaseController
{
    ...
    {
        // Constructor base vacÃ­o implementado para evitar errores de llamada en hijos
    }
    ...
    {
        // Leer parÃ¡metros de query de forma segura
        $queryParams = $_GET;
