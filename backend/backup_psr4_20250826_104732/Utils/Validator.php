...
namespace Utils\Validator.php\Utils;
...
class Validator
{
    ...
    public static function string($v, int $min = 0, int $max = 255, string $field = 'string'): void
    {
        ...
        $len = mb_strlen($v);
        if ($len < $min) {
            throw new \InvalidArgumentException("$field: longitud mÃ­nima $min");
        }
        if ($len > $max) {
            throw new \InvalidArgumentException("$field: longitud mÃ¡xima $max");
        }
    }
    ...
    public static function date($v, string $field = 'date'): void
    {
        ...
        if (!checkdate($m, $d, $Y)) {
            throw new \InvalidArgumentException("$field no es una fecha vÃ¡lida");
        }
    }
    ...
    public static function uuidLike($v, string $field = 'id'): void
    {
        if (!is_string($v) || $v === '' || strlen($v) > 36) {
            throw new \InvalidArgumentException("$field invÃ¡lido (esperado tipo char(36))");
        }
    }
    ...
    public static function email($v, string $field = 'email'): void
    {
        if (!filter_var($v, FILTER_VALIDATE_EMAIL)) {
            throw new \InvalidArgumentException("$field no es un email vÃ¡lido");
        }
    }
    ...
    public static function url($v, string $field = 'url'): void
    {
        if (!filter_var($v, FILTER_VALIDATE_URL)) {
            throw new \InvalidArgumentException("$field no es una URL vÃ¡lida");
        }
    }
    ...
    public static function validate(array $data, array $rules): array
    {
        ...
        foreach ($rules as $field => $ruleStr) {
            ...
            foreach ($ruleset as $rule) {
                ...
                if ($rule === 'numeric') {
                    if (!is_numeric($value)) {
                        $errors[$field][] = "$field debe ser numÃ©rico";
                    }
                    continue;
                }
    ...
    private function validateMax(string $field, ?string $max): bool
    {
        ...
        $ok = mb_strlen((string)$this->data[$field]) <= $M;
        if (!$ok) {
            $this->errors[$field] = "El campo '$field' debe tener como mÃ¡ximo $M caracteres";
        }
        return $ok;
    }
    ...
    private function validateNumeric(string $field): bool
    {
        ...
        if (!$ok) {
            $this->errors[$field] = "El campo '$field' debe ser numÃ©rico";
        }
        return $ok;
    }
    ...
    private function validateDate(string $field): bool
    {
        ...
        if (!$ok) {
            $this->errors[$field] = "El campo '$field' debe ser una fecha vÃ¡lida";
        }
        return $ok;
    }
    ...
    private function validateUrl(string $field): bool
    {
        ...
        if (!$ok) {
            $this->errors[$field] = "El campo '$field' debe ser una URL vÃ¡lida";
        }
        return $ok;
    }
    ...
    private function validateInteger(string $field, ?string $range = null): bool
    {
        ...
        if (!$ok) {
            $this->errors[$field] = "El campo '$field' debe ser un entero vÃ¡lido";
            return false;
        }
    ...
    private function validateFloat(string $field): bool
    {
        ...
        if (!$ok) {
            $this->errors[$field] = "El campo '$field' debe ser un decimal vÃ¡lido";
        }
        return $ok;
    }
    ...
    private function validateAlphanumeric(string $field): bool
    {
        ...
        if (!$ok) {
            $this->errors[$field] = "El campo '$field' debe contener solo letras y nÃºmeros";
        }
        return $ok;
    }
    ...
    private function validateJson(string $field): bool
    {
        ...
        if (!$ok) {
            $this->errors[$field] = "El campo '$field' debe contener JSON vÃ¡lido";
        }
        return $ok;
    }
    ...
    private function validateIp(string $field, ?string $version = null): bool
    {
        ...
        if (!$ok) {
            $this->errors[$field] = "El campo '$field' debe ser una IP vÃ¡lida" . ($version ? " ($version)" : '');
        }
        return $ok;
    }
    ...
    private function validateStrongPassword(string $field, ?string $level = 'medium'): bool
    {
        ...
        if ($lvl === 'basic') {
            ...
            if (!preg_match('/[A-Z]/', $pwd)) {
                $errors[] = 'al menos una mayÃºscula';
            }
            if (!preg_match('/[a-z]/', $pwd)) {
                $errors[] = 'al menos una minÃºscula';
            }
            if (!preg_match('/[0-9]/', $pwd)) {
                $errors[] = 'al menos un nÃºmero';
            }
        } else { // strong
            if (strlen($pwd) < 12) {
            ...
            if (!preg_match('/[!@#$%^&*(),.?":{}|<>]/', $pwd)) {
                $errors[] = 'al menos un carÃ¡cter especial';
            }
        }
    ...
    private function validatePhone(string $field): bool
    {
        ...
        if (!$ok) {
            $this->errors[$field] = "El campo '$field' debe ser un telÃ©fono vÃ¡lido";
        }
        return $ok;
    }
