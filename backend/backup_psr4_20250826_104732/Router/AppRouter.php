...
namespace Router\AppRouter.php\Router;
...
class AppRouter
{
   ...
   * Nota: aÃ±ade aquÃ­ cualquier ruta nueva y, si debe requerir auth,
  ...
  private function setupRoutes(): void
  {
    ...
    // Usamos comodÃ­n para ids tipo 'job-102'
  ...
  /**
   * VerificaciÃ³n simple de autenticaciÃ³n.
   * Sustituye este mÃ©todo con validaciÃ³n real de JWT/cookie segÃºn tu proyecto.
   */
  private function checkAuthentication(): bool
  {
    ...
    if (stripos($authHeader, 'Bearer ') === 0) {
      ...
      // TODO: validar JWT real aquÃ­ (recomiendo firebase/php-jwt)
      return !empty($token);
    }

    // Fallback: sesiÃ³n PHP
  ...
  private function callController(string $controllerName, string $method, array $params)
  {
    ...
    // Firma estÃ¡ndar: action(Request $req, array $params)
