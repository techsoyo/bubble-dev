...
// Importar JWT helper
require_once $ROOT . '/src/Utils/JWTHelper.php';

// Configurar headers CORS primera lÃ­nea
...
// Resetear contador si han pasado mÃ¡s de 15 minutos
if (time() - $_SESSION[$attemptsKey]['last_attempt'] > 900) {
    $_SESSION[$attemptsKey] = ['count' => 0, 'last_attempt' => time()];
}

// Bloquear si hay mÃ¡s de 5 intentos en 15 minutos
...
try {
    ...
    if ($method === 'POST') {
        ...
        // Consulta a la base de datos con mÃ¡s campos necesarios
