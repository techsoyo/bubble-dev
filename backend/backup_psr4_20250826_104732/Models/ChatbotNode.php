...
namespace Models\ChatbotNode.php\Models;
 ...
 * 
 * Representa cada mensaje, opciÃ³n, formulario o redirecciÃ³n en el flujo conversacional.
 * Incluye funcionalidades avanzadas para manejo de Ã¡rboles jerÃ¡rquicos, cache optimizado,
 * y validaciÃ³n robusta de flujos de conversaciÃ³n.
 *
 * @package Models
...
class ChatbotNode extends BaseModel
{
    ...
    /**
     * Cache para Ã¡rboles de conversaciÃ³n
     */
    ...
    /**
     * Obtener la estructura jerÃ¡rquica completa del chatbot
     * 
     * Construye el Ã¡rbol completo de nodos del chatbot con sus relaciones padre-hijo,
     ...
     * @return array Estructura jerÃ¡rquica de nodos
    ...
    /**
     * Encontrar nodos hijos de un nodo especÃ­fico
     *
     ...
     * @throws \InvalidArgumentException Si el parent_id es invÃ¡lido
     * @throws \RuntimeException Si hay error en la consulta
     */
    ...
    /**
     * Ejecutar la acciÃ³n asociada a un nodo
     *
     * @param string|int $nodeId ID del nodo
     * @param array $context Contexto de la conversaciÃ³n
     * @param array $userInput Input del usuario
     * @return array Resultado de la ejecuciÃ³n
     * @throws \InvalidArgumentException Si los parÃ¡metros son invÃ¡lidos
     * @throws \RuntimeException Si hay error en la ejecuciÃ³n
     */
    public function executeNodeAction($nodeId, array $context = [], array $userInput = []): array
    {
        ...
        try {
            ...
            // Verificar que el nodo estÃ© activo
            ...
            // Ejecutar acciones segÃºn el tipo de nodo
    ...
    /**
     * Validar el flujo de conversaciÃ³n desde un nodo raÃ­z
     *
     * @param string|int $startNodeId ID del nodo inicial
     * @param int $maxDepth Profundidad mÃ¡xima a validar
     * @return array Resultado de la validaciÃ³n
     * @throws \InvalidArgumentException Si los parÃ¡metros son invÃ¡lidos
     * @throws \RuntimeException Si hay error en la validaciÃ³n
     */
    public function validateNodeFlow($startNodeId, int $maxDepth = 50): array
    {
        ...
        try {
            ...
            // Obtener todos los nodos activos para validaciÃ³n
            ...
            // Realizar validaciÃ³n recursiva
            $visitedNodes = [];
            $pathStack = [];
            ...
            // Determinar si la validaciÃ³n es exitosa
    ...
    /**
     * Limpiar cache de Ã¡rboles de conversaciÃ³n
     */
    ...
    /**
     * Construir jerarquÃ­a de nodos recursivamente
     */
    ...
    private function evaluateNodeConditions(array $conditions, array $context, array $userInput): array
    {
        ...
        // ImplementaciÃ³n bÃ¡sica de evaluaciÃ³n de condiciones
    ...
    /**
     * Evaluar una condiciÃ³n individual
     */
    private function evaluateSingleCondition(array $condition, array $context, array $userInput): bool
    {
        // ImplementaciÃ³n bÃ¡sica - se puede extender segÃºn necesidades
        $type = $condition['type'] ?? '';
    ...
    /**
     * Comparar valores segÃºn operador
     */
    ...
    /**
     * Ejecutar acciÃ³n de formulario
     */
    ...
    /**
     * Ejecutar acciÃ³n de redirecciÃ³n
     */
    ...
    private function executeConditionAction(array $node, array $actions, array $context, array $userInput, array $result): array
    {
        ...
        // Determinar siguiente nodo basado en la condiciÃ³n
        if ($conditionResult['passed']) {
    ...
    private function executeCustomAction(array $node, array $actions, array $context, array $userInput, array $result): array
    {
        ...
        // Procesar acciones personalizadas segÃºn configuraciÃ³n
    ...
    private function validateNodeStructure(array $node, array &$validation): void
    {
        ...
        // Validar JSON vÃ¡lido en campos metadata, conditions, actions
    ...
    /**
     * Override del mÃ©todo store para validaciÃ³n adicional
     */
    ...
    /**
     * Override del mÃ©todo update para validaciÃ³n adicional
     */
    ...
    /**
     * Override del mÃ©todo delete para limpiar cache
     */
    ...
    /**
     * MÃ©todo de compatibilidad hacia atrÃ¡s - Obtener todos los nodos activos
     */
    ...
    /**
     * MÃ©todo de compatibilidad hacia atrÃ¡s - Obtener nodo por ID
     */
    ...
    /**
     * MÃ©todo de compatibilidad hacia atrÃ¡s - Obtener nodos por tipo
     */
    ...
    /**
     * MÃ©todo de compatibilidad hacia atrÃ¡s - Verificar existencia
     */
    ...
    /**
     * MÃ©todo de compatibilidad hacia atrÃ¡s - Obtener estadÃ­sticas
     */
     ...
     * @param array $filters Filtros de bÃºsqueda
     * @return int NÃºmero total de chatbot_nodes
     */
    ...
    /**
     * Validar datos especÃ­ficos de chatbot_nodes
    ...
    /**
     * Invalidar cache especÃ­fico de chatbot_nodes
     */
