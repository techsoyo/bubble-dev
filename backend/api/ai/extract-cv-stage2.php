...
$prompt = "Tarea: Analizar y estructurar en formato JSON el siguiente CV ya filtrado.\n\n" .
  "Instrucciones:\n" .
  "1. Extrae los siguientes campos, si están disponibles:\n" .
  "   - nombre, email, teléfono\n" .
  "   - formación académica: título, institución, fechas\n" .
  ...
  "3. No inventes campos que no estén. Si algo no se encuentra, deja el array vacío.\n" .
...
if (!isset($data['response'])) {
    echo json_encode([
      'error' => 'Respuesta inválida de Ollama (recruitment-ai)',
...
if ($jsonStart !== false && $jsonEnd !== false) {
    ...
    if ($parsedJson) {
        ...
        // JSON inválido, usar respuesta cruda pero marcar como no parseado
