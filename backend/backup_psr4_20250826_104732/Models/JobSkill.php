...
namespace Models\JobSkill.php\Models;
 ...
 * 
 * Proporciona funcionalidades avanzadas para anÃ¡lisis de mercado de habilidades,
 * matching de candidatos, y anÃ¡lisis de demanda/oferta usando vistas optimizadas.
 * 
 * @package Models
...
class JobSkill extends BaseModel
{
     ...
     * 
     * Cambios realizados:
     * âž• Campos aÃ±adidos: ['skill_id', 'required_level', 'weight']
     * âŒ Campos removidos: ['skill', 'proficiency_level', 'years_experience']
     * ðŸ“Š Total campos fillable: 5
     * 
    ...
    /**
     * Cache para anÃ¡lisis de mercado (TTL: 1 hora)
     */
    private const CACHE_TTL = 3600;

    /**
     * MÃ‰TODOS BÃSICOS - Funcionalidad original mejorada
     */
    ...
    /**
     * MÃ‰TODOS DE ANÃLISIS DE DEMANDA Y OFERTA - Usando vistas optimizadas
     */

    /**
     * Obtiene anÃ¡lisis de demanda de habilidades usando vw_skill_demand
     * 
     * @param array $filters Filtros opcionales
     * @param int $limit LÃ­mite de resultados
     * @return array AnÃ¡lisis de demanda por habilidad
     */
    ...
    /**
     * Obtiene anÃ¡lisis de oferta de habilidades usando vw_skill_supply
     * 
     * @param array $filters Filtros opcionales
     * @param int $limit LÃ­mite de resultados
     * @return array AnÃ¡lisis de oferta por habilidad
     */
    ...
    /**
     * Obtiene anÃ¡lisis de brecha del mercado combinando demanda y oferta
     * 
     * @param int $limit LÃ­mite de resultados
     * @return array AnÃ¡lisis de brechas por habilidad
     */
    ...
    /**
     * Obtiene habilidades mÃ¡s demandadas (trending)
     * 
     * @param int $days DÃ­as hacia atrÃ¡s para el anÃ¡lisis
     * @param int $limit LÃ­mite de resultados
    ...
    public function getTrendingSkills(int $days = 30, int $limit = 20): array
    {
        ...
        try {
            ...
            // Cache por 30 minutos (mÃ¡s frecuente para trends)
            $this->cache[$cacheKey] = $result;
    ...
    /**
     * MÃ‰TODOS DE INTEGRACIÃ“N CON VISTAS - Para matching y bÃºsquedas avanzadas
     */
     ...
     * @param int $minMatchedSkills MÃ­nimo de habilidades coincidentes
     * @param int $limit LÃ­mite de resultados
     ...
     * 
     * @param string $jobId ID del trabajo
     * @return array Habilidades optimizadas con anÃ¡lisis de mercado
     */
    ...
    /**
     * MÃ‰TODOS DE UTILIDAD Y HELPERS PRIVADOS
     */
    ...
    /**
     * AÃ±ade recomendaciones de mercado basadas en brechas
     */
        ...
        foreach ($data as &$row) {
            ...
            switch ($row['market_status']) {
                case 'critical_shortage':
                    ...
                    $recommendations[] = 'Considerar programas de capacitaciÃ³n interna';
                    $recommendations[] = 'Evaluar contrataciÃ³n remota o internacional';
                    break;

                case 'high_demand':
                    $recommendations[] = 'Acelerar procesos de selecciÃ³n';
                ...
                case 'oversupply':
                    $recommendations[] = 'Elevar estÃ¡ndares de selecciÃ³n';
                    $recommendations[] = 'Proceso de evaluaciÃ³n mÃ¡s riguroso';
    ...
    /**
     * AÃ±ade recomendaciones de reclutamiento
     */
        ...
        foreach ($data as &$row) {
            ...
            switch ($row['availability_status']) {
                ...
                case 'scarce':
                    ...
                    $recruitmentAdvice[] = 'Acelerar proceso de selecciÃ³n';
                    break;
    ...
    /**
     * Calcula percentil de un array de nÃºmeros
     */
    ...
    /**
     * Calcula score de recomendaciÃ³n
     */
     ...
     * @param array $filters Filtros de bÃºsqueda
     * @return int NÃºmero total de job_skills
     */
    ...
    /**
     * Validar datos especÃ­ficos de job_skills
    ...
    /**
     * Invalidar cache especÃ­fico de job_skills
     */
