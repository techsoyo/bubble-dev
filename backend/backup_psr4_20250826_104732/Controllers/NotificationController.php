...
namespace Controllers\NotificationController.php\Controllers;
...
class NotificationController extends BaseController
{
  ...
  public function index(Request $request, array $params = [])
  {
    try {
      ...
      // Usar mÃ©todo existente del modelo
  ...
  public function show(Request $request, array $params = [])
  {
    try {
      ...
      if (!$row) {
        return ResponseHelper::fail('NotificaciÃ³n no encontrada', 404);
      }

      return ResponseHelper::success('NotificaciÃ³n encontrada', $row, 200);
    } catch (\Throwable $e) {
      Logger::error('Error retrieving notification', ['id' => $id, 'error' => $e->getMessage()]);
      return ResponseHelper::error('Error al obtener notificaciÃ³n', $e, 500);
    }
  }
  ...
  public function store(Request $request, array $params = [])
  {
    try {
      ...
      return ResponseHelper::success('NotificaciÃ³n creada', ['id' => $id], 201);
      ...
      return ResponseHelper::error('Error al crear notificaciÃ³n', $e, 500);
    }
  }
  ...
  public function update(Request $request, array $params = [])
  {
    try {
      ...
      return ResponseHelper::success("NotificaciÃ³n $id actualizada", ['success' => true], 200);
    } catch (\InvalidArgumentException $e) {
      ...
      return ResponseHelper::error('Error al actualizar notificaciÃ³n', $e, 500);
    }
  }
  ...
  public function markAsRead(Request $request, array $params = [])
  {
    try {
      ...
      return ResponseHelper::success("NotificaciÃ³n $id marcada como leÃ­da", ['success' => true], 200);
    } catch (\Throwable $e) {
      Logger::error('Unexpected error marking notification as read', ['id' => $id, 'error' => $e->getMessage()]);
      return ResponseHelper::error('Error al marcar notificaciÃ³n como leÃ­da', $e, 500);
    }
  }
  ...
  public function delete(Request $request, array $params = [])
  {
    try {
      ...
      return ResponseHelper::success("NotificaciÃ³n $id eliminada", [], 204);
    } catch (\Throwable $e) {
      Logger::error('Unexpected error deleting notification', ['id' => $id, 'error' => $e->getMessage()]);
      return ResponseHelper::error('Error al eliminar notificaciÃ³n', $e, 500);
    }
  }
