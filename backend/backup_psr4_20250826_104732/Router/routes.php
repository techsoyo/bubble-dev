...
namespace Router\routes.php\Router;



/**
 * Archivo centralizado de rutas para la aplicaciÃ³n Bubble of Talents
 * 
 * Este archivo contiene todas las rutas detectadas en la tabla de endpoints.
 * Al instanciar AppRouter, las rutas se configuran internamente en el mÃ©todo
 ...
 * NOTA IMPORTANTE:
 * 
 * La implementaciÃ³n actual de AppRouter no permite configurar rutas
 * externamente como se requiere. Para solucionar esto, se recomienda:
 * 
 * 1. Modificar AppRouter.php para que la configuraciÃ³n de rutas se realice
 *    a travÃ©s de mÃ©todos pÃºblicos, permitiendo que este archivo las configure.
 * 
 ...
 * 
 * // 4. ENDPOINTS DE ANÃLISIS DE CV
...
// =====================================================
// 11. ENDPOINTS ESPECÃFICOS DE DATOS
// =====================================================
...
// =====================================================
// 16. ENDPOINTS DE ASIGNACIÃ“N Y GESTIÃ“N
// =====================================================
