...
namespace Controllers\JobCategoryController.php\Controllers;
...
class JobCategoryController extends BaseController
{
  ...
  public function index(Request $request, array $params = [])
  {
    try {
      ...
      // Si se solicitan solo categorÃ­as principales
      ...
      return ResponseHelper::success('Lista de categorÃ­as de trabajo', [
        'data' => $categories,
        'total' => $total,
        'page' => $page,
        'limit' => $limit
      ...
      return ResponseHelper::error('Error al listar categorÃ­as de trabajo', $e, 500);
    }
  }
  ...
  public function show(Request $request, array $params = [])
  {
    try {
      ...
      if (!$category) {
        return ResponseHelper::fail('CategorÃ­a de trabajo no encontrada', 404);
      }

      return ResponseHelper::success('CategorÃ­a de trabajo encontrada', $category, 200);
    } catch (\Throwable $e) {
      Logger::error('Error retrieving job category', ['id' => $id, 'error' => $e->getMessage()]);
      return ResponseHelper::error('Error al obtener categorÃ­a de trabajo', $e, 500);
    }
  }
  ...
  public function store(Request $request, array $params = [])
  {
    try {
      ...
      return ResponseHelper::success('CategorÃ­a de trabajo creada', ['id' => $id], 201);
      ...
      return ResponseHelper::error('Error al crear categorÃ­a de trabajo', $e, 500);
    }
  }
  ...
  public function update(Request $request, array $params = [])
  {
    try {
      ...
      return ResponseHelper::success("CategorÃ­a de trabajo $id actualizada", ['success' => true], 200);
    } catch (\InvalidArgumentException $e) {
      ...
      return ResponseHelper::error('Error al actualizar categorÃ­a de trabajo', $e, 500);
    }
  }
  ...
  public function delete(Request $request, array $params = [])
  {
    try {
      ...
      return ResponseHelper::success("CategorÃ­a de trabajo $id eliminada", [], 204);
    } catch (\InvalidArgumentException $e) {
      ...
      return ResponseHelper::error('Error al eliminar categorÃ­a de trabajo', $e, 500);
    }
  }
}
