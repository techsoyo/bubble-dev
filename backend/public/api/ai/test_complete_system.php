...
// Proteger endpoint de pruebas en entornos de producciÃƒÆ’Ã‚Â³n.
...
if ($response && isset($response['status'])) {
    if ($response['status'] === 'ok') {
        echo "ÃƒÂ°Ã…Â¸Ã…Â½Ã¢â‚¬Â° Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã¢â‚¬Â°XITO! CV procesado completamente en 2 etapas\n\n";

        echo "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â  ESTADÃƒÆ’Ã‚ÂSTICAS GENERALES:\n";
        echo "==========================\n";
        ...
        echo "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‹â€  ETAPA 1 (EXTRACCIÃƒÆ’Ã¢â‚¬Å“N CON LLAMA3):\n";
        echo "===================================\n";
        echo 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â TamaÃƒÆ’Ã‚Â±o original: ' . $response['stage1']['original_size'] . " caracteres\n";
        echo 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â TamaÃƒÆ’Ã‚Â±o limpio: ' . $response['stage1']['clean_size'] . " caracteres\n";
        echo 'ÃƒÂ°Ã…Â¸Ã¢â‚¬â€Ã…â€œÃƒÂ¯Ã‚Â¸Ã‚Â  ReducciÃƒÆ’Ã‚Â³n: ' . $response['stage1']['reduction_ratio'] . "\n\n";

        echo "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Â¹ ETAPA 2 (JSON CON RECRUITMENT-AI):\n";
        echo "=====================================\n";
        echo 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â TamaÃƒÆ’Ã‚Â±o JSON: ' . $response['stage2']['json_size'] . " caracteres\n";
        echo 'ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ JSON vÃƒÆ’Ã‚Â¡lido: ' . ($response['stage2']['json_valid'] ? 'SÃƒÆ’Ã‚Â­' : 'No') . "\n";
        echo 'ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬Ëœ Campos extraÃƒÆ’Ã‚Â­dos: ' . implode(', ', $response['stage2']['extracted_fields']) . "\n\n";
        ...
        echo "==================\n";
        echo "ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“ Etapa 1 completada (ExtracciÃƒÆ’Ã‚Â³n)\n";
        echo "ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“ Etapa 2 completada (EstructuraciÃƒÆ’Ã‚Â³n)\n";
        echo "ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“ Archivos generados correctamente\n";
        echo "ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“ JSON vÃƒÆ’Ã‚Â¡lido generado\n";
