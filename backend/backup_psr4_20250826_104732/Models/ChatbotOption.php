...
namespace Models\ChatbotOption.php\Models;
 ...
 * Incluye funcionalidades avanzadas de cache, validaciÃ³n de flujo y estadÃ­sticas.
 * 
 * @package Models
...
class ChatbotOption extends BaseModel
{
     ...
     * 
     * Cambios realizados:
     * âž• Campos aÃ±adidos: ['option_text', 'value', 'sort_order', 'metadata']
     * âŒ Campos removidos: ['text', 'action_type', 'action_data', 'order_position']
     * ðŸ“Š Total campos fillable: 7
     * 
    ...
    /**
     * Obtener opciones de un nodo especÃ­fico con cache
     * 
     * @param string $nodeId ID del nodo
     * @param bool $activeOnly Solo opciones activas
     * @return array Lista de opciones del nodo
     * 
     * @throws \InvalidArgumentException Si nodeId estÃ¡ vacÃ­o
    ...
    /**
     * Procesar selecciÃ³n de usuario y retornar siguiente acciÃ³n
     * 
     * @param string $optionId ID de la opciÃ³n seleccionada
     * @param array $userData Datos del usuario para contexto
     * @return array InformaciÃ³n de la siguiente acciÃ³n
     * 
     * @throws \InvalidArgumentException Si optionId estÃ¡ vacÃ­o
     * @throws \RuntimeException Si la opciÃ³n no existe o hay error
     */
     ...
     * 
     * @param string $optionId ID de la opciÃ³n
     * @param string $nextNodeId ID del siguiente nodo
     * @return bool True si el flujo es vÃ¡lido
     * 
     * @throws \InvalidArgumentException Si los IDs estÃ¡n vacÃ­os
    ...
    /**
     * Obtener estadÃ­sticas de uso de opciones
     * 
     * @param int $days DÃ­as atrÃ¡s para calcular estadÃ­sticas
     * @return array EstadÃ­sticas detalladas
     * 
    ...
    {
        try {
            // EstadÃ­sticas bÃ¡sicas de opciones
            ...
            // EstadÃ­sticas por tipo de acciÃ³n
            ...
            // EstadÃ­sticas de uso desde analytics (si existe la tabla)
            $usageStats = [];
            try {
    ...
    /**
     * Reordenar opciones de un nodo especÃ­fico
     * 
     * @param string $nodeId ID del nodo
    ...
    /**
     * Crear nueva opciÃ³n con validaciones
     * 
     * @param array $data Datos de la nueva opciÃ³n
     * @return mixed ID de la nueva opciÃ³n
     * 
     * @throws \InvalidArgumentException Si los datos son invÃ¡lidos
     * @throws \RuntimeException Si hay error en la creaciÃ³n
     */
    ...
    /**
     * Actualizar opciÃ³n con validaciones
     * 
     * @param mixed $id ID de la opciÃ³n
    ...
    /**
     * Obtener siguiente posiciÃ³n de orden para un nodo
     * 
     * @param string $nodeId ID del nodo
     * @return int Siguiente posiciÃ³n disponible
     */
    ...
    /**
     * Obtener opciÃ³n por ID con cache
     * 
     * @param mixed $id ID de la opciÃ³n
     * @return array|null Datos de la opciÃ³n o null si no existe
     */
     ...
     * @param array $filters Filtros de bÃºsqueda
     * @return int NÃºmero total de chatbot_options
     */
    ...
    /**
     * Validar datos especÃ­ficos de chatbot_options
    ...
    /**
     * Invalidar cache especÃ­fico de chatbot_options
     */
