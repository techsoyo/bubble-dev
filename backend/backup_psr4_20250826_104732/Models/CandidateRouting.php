...
namespace Models\CandidateRouting.php\Models;
 ...
 *
 * Gestiona la asignaciÃ³n de candidatos a departamentos, categorÃ­as de departamento
 * y recruiters especÃ­ficos para optimizar el proceso de reclutamiento.
 *
 * @package Models
...
class CandidateRouting extends BaseModel
{
     ...
     * 
     * Cambios realizados:
     * âž• Campos aÃ±adidos: ['source_channel', 'utm_source', 'utm_medium', 'utm_campaign', 'referrer_url']
     * âŒ Campos removidos: ['department_id', 'department_category_id', 'recruiter_id', 'assigned_at', 'status']
    ...
    /**
     * Estados vÃ¡lidos para el enrutamiento
     */
    ...
    /**
     * Encontrar el Ãºltimo enrutamiento de un candidato
     *
     * @param int $candidateId ID del candidato
     * @return array|null Ãšltimo enrutamiento o null si no existe
     ...
     * @param int|null $departmentCategoryId ID de la categorÃ­a de departamento (opcional)
    ...
    public function updateRoutingStatus($routingId, string $newStatus, ?int $newRecruiterId = null): bool
    {
        ...
        try {
            ...
            // Si se proporciona nuevo recruiter, actualizar tambiÃ©n
            if ($newRecruiterId !== null) {
                $data['recruiter_id'] = $newRecruiterId;
                $data['assigned_at'] = date('Y-m-d H:i:s'); // Actualizar tiempo de asignaciÃ³n
            }
     ...
     * @param string $reason RazÃ³n de la reasignaciÃ³n (opcional)
     * @return bool True si la reasignaciÃ³n fue exitosa
     * @throws \InvalidArgumentException Si los datos son invÃ¡lidos
     * @throws \RuntimeException Si ocurre un error en la base de datos
     */
    ...
    /**
     * Obtener candidatos asignados a un recruiter especÃ­fico
     *
     * @param int $recruiterId ID del recruiter
     * @param array $statusFilter Filtro de estados (opcional)
     * @param int $limit LÃ­mite de resultados (por defecto 50)
    ...
    /**
     * Obtener estadÃ­sticas de carga de trabajo por recruiter usando vista optimizada
     *
     * @param int|null $departmentId Filtro por departamento (opcional)
     * @return array EstadÃ­sticas de carga de trabajo
     * @throws \RuntimeException Si ocurre un error en la base de datos
     */
     ...
     *
     * @param int $candidateId ID del candidato
     * @return array Historial de enrutamientos ordenado cronolÃ³gicamente
     * @throws \InvalidArgumentException Si el candidateId es invÃ¡lido
     * @throws \RuntimeException Si ocurre un error en la base de datos
     */
     ...
     * @param array $filters Filtros de bÃºsqueda
     * @return int NÃºmero total de candidate_routings
     */
    ...
    /**
     * Validar datos especÃ­ficos de candidate_routings
    ...
    /**
     * Invalidar cache especÃ­fico de candidate_routings
     */
