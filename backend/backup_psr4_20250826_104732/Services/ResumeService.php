...
namespace Services\ResumeService.php\Services;
...
class ResumeService
{
     ...
     * @return array Resultado del anÃ¡lisis
     * @throws Exception
     */
    public function processResume(string $filePath): array
    {
        ...
        if (trim($text) === '') {
            throw new Exception('El archivo estÃ¡ vacÃ­o o no se pudo extraer texto');
        }
    ...
    {
        // ImplementaciÃ³n real pendiente: invocar proveedor de IA y procesar la respuesta
