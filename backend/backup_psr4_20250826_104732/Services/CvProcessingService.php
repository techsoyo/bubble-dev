...
namespace Services\CvProcessingService.php\Services;
 ...
 * Nueva implementaciÃ³n con arquitectura moderna
 */
class CvProcessingService
{
  ...
  public function processUpload(CvUploadRequest $request, string $requestId): array
  {
    ...
    try {
      ...
      // 2. Verificar cachÃ© por hash del archivo
  ...
  {
    // Intentar con proveedor especÃ­fico o buscar uno disponible
    ...
    // Procesar segÃºn el tipo de servicio
