...
// 4.1. PRE-LIMPIEZA BÁSICA para reducir tamaño antes de enviar a LLaMA3
...
// 6. Construir el prompt para extracción con LLaMA3 (más conciso)
$prompt = "Extrae solo información útil de este CV. Incluye:\n" .
  "- Nombre, contacto, ubicación\n" .
  "- Estudios (título, institución, año)\n" .
  "- Trabajo (empresa, puesto, años, funciones principales)\n" .
...
// 7. Enviar al modelo Mistral de Ollama (más rápido que LLaMA3)
...
curl_setopt_array($curl, [
  ...
  CURLOPT_TIMEOUT => 90, // 1.5 minutos para extracción
...
if (!isset($data['response'])) {
    echo json_encode([
      'error' => 'Respuesta inválida de Ollama (LLaMA3)',
