 ...
 *
 * Endpoint para scoring automÃ¡tico y anÃ¡lisis de compatibilidad
...
try {
    ...
    switch ($action) {
        ...
        case 'rank_candidates':
            // Ranking de mÃºltiples candidatos
        ...
        case 'qualification_analysis':
            // AnÃ¡lisis de sobre/subcalificaciÃ³n
            if (!isset($input['candidate_data']) || !isset($input['job_data'])) {
                http_response_code(400);
                echo json_encode(['error' => 'Faltan candidate_data o job_data']);
                exit;
        ...
        case 'batch_analysis':
            // AnÃ¡lisis completo: matching + qualification
            if (!isset($input['candidate_data']) || !isset($input['job_data'])) {
                http_response_code(400);
                echo json_encode(['error' => 'Faltan candidate_data o job_data']);
                exit;
