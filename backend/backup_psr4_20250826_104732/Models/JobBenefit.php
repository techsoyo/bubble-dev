...
namespace Models\JobBenefit.php\Models;
...
class JobBenefit extends BaseModel
{
     ...
     * âŒ Campos removidos: ['description', 'value', 'currency', 'is_required']
     ...
     * Incluye informaciÃ³n sensible monetaria e interna
     */
    protected array $hidden = [
        'value',        // InformaciÃ³n monetaria sensible
        'internal_cost' // Costos internos de la empresa
    ];

    /**
     * Tipos de beneficios vÃ¡lidos
     */
    ...
    /**
     * Obtener todos los beneficios asociados a un trabajo especÃ­fico
     * 
     ...
     * 
     * @throws \InvalidArgumentException Si el jobId es invÃ¡lido
    ...
    /**
     * Obtener beneficios filtrados por tipo especÃ­fico
     * 
     ...
     * 
     * @throws \InvalidArgumentException Si el tipo de beneficio es invÃ¡lido
     * @throws \RuntimeException Si ocurre un error en la consulta
     */
     ...
     * 
     * @param string|int|null $jobId ID especÃ­fico del trabajo (opcional)
     * @param int $limit LÃ­mite de resultados
     * @param int $cacheTtl Tiempo de vida del cache en segundos
     ...
     * 
     * @param string|int $jobId ID del trabajo
     * @param string $targetCurrency Moneda objetivo para la conversiÃ³n (opcional)
     * @param bool $requiredOnly Si calcular solo beneficios obligatorios
     * @param int $cacheTtl Tiempo de vida del cache en segundos
     * @return array InformaciÃ³n del valor total con desglose por moneda
     * 
        ...
        try {
            ...
            foreach ($benefits as $benefit) {
                ...
                if ($value > 0) {
                    ...
                    // Sumar al total (en la prÃ¡ctica aquÃ­ se harÃ­a conversiÃ³n de moneda)
                    $totalValue += $value;
                }
            }
    ...
    /**
     * Validar si un tipo de beneficio es vÃ¡lido
     * 
     * @param string $benefitType Tipo de beneficio a validar
     * @return bool True si es vÃ¡lido, false en caso contrario
     */
    ...
    /**
     * Validar si una moneda es vÃ¡lida
     * 
     * @param string $currency CÃ³digo de moneda a validar
     * @return bool True si es vÃ¡lida, false en caso contrario
     */
     ...
     * @throws \RuntimeException Si ocurre un error en la creaciÃ³n
     */
     ...
     * 
     * @throws \InvalidArgumentException Si los datos no son vÃ¡lidos
     * @throws \RuntimeException Si ocurre un error en la actualizaciÃ³n
     */
    public function updateBenefit($id, array $data): bool
    {
        ...
        // Limpiar cache para el nuevo job_id si cambiÃ³
     ...
     * @throws \RuntimeException Si ocurre un error en la eliminaciÃ³n
     */
    ...
    private function validateBenefitData(array $data, bool $isUpdate = false): void
    {
        ...
        // Validar tipo de beneficio si estÃ¡ presente
        ...
        // Validar moneda si estÃ¡ presente
        ...
        // Validar valor monetario si estÃ¡ presente
        ...
        // Validar is_required si estÃ¡ presente
     ...
     * (MÃ©todo original mantenido por compatibilidad)
     *
     ...
     * 
     * @return array Lista de tipos vÃ¡lidos de beneficios
     */
     ...
     * 
     * @return array Lista de cÃ³digos de moneda vÃ¡lidos
     */
     ...
     * @param array $filters Filtros de bÃºsqueda
     * @return int NÃºmero total de job_benefits
     */
    ...
    /**
     * Validar datos especÃ­ficos de job_benefits
     * @param array $data Datos a validar
    ...
    private function validateJobBenefitData(array $data, $id = null): void
    {
        ...
        // Validar que benefit_type estÃ© en la lista de tipos vÃ¡lidos si se proporciona
    ...
    /**
     * Invalidar cache especÃ­fico de job_benefits
     */
