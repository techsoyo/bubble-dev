...
try {
    ...
    $mockData = [
        ['id' => 1, 'job_id' => 'job-101', 'requirement' => 'Experiencia mÃ­nima 3 aÃ±os'],
        ['id' => 2, 'job_id' => 'job-101', 'requirement' => 'Dominio de JavaScript'],
        ['id' => 3, 'job_id' => 'job-102', 'requirement' => 'TÃ­tulo universitario'],
        ['id' => 4, 'job_id' => 'job-103', 'requirement' => 'InglÃ©s nivel B2'],
