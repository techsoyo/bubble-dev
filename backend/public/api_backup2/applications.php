...
// ===== GET: AHORA CON AUTENTICACIÃ“N JWT =====
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    // âœ… REQUERIR AUTENTICACIÃ“N JWT
    ...
    try {
        ...
        $limit = min((int)($_GET['limit'] ?? 20), 100); // MÃ¡ximo 100
        $offset = (int)($_GET['offset'] ?? 0);

        // âœ… CONTROL DE ACCESO: Solo admins o el propio candidato puede ver aplicaciones
        ...
        // âœ… QUERY SEGURA CON JOINS Y PREPARED STATEMENTS
        $sql = "
            SELECT 
                a.id,
                a.candidate_id,
        ...
        // âœ… SANITIZAR DATOS SENSIBLES SEGÃšN ROL
...
// ===== POST: TAMBIÃ‰N REQUIERE AUTENTICACIÃ“N =====
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // âœ… VERIFICAR QUE EL TRABAJO EXISTE Y ESTÃ ACTIVO
        ...
        // âœ… VERIFICAR QUE NO HAYA APLICACIÃ“N DUPLICADA
        ...
        // âœ… CREAR APLICACIÃ“N CON PREPARED STATEMENTS
        ...
        if (!$success) {
            throw new Exception('Error al insertar aplicaciÃ³n');
        }
        ...
        jsend(true, 'AplicaciÃ³n creada exitosamente', [
            'id' => $applicationId,
            'candidate_id' => $candidateId,
            'job_id' => $jobId,
            'job_title' => $job['title'],
