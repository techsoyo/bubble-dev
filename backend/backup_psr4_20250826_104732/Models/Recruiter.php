...
namespace Models\Recruiter.php\Models;
 ...
 * la distribuciÃ³n de carga de trabajo, mÃ©tricas de rendimiento y asignaciÃ³n
...
class Recruiter extends BaseModel
{
     ...
     * 
     * Cambios realizados:
     * âž• Campos aÃ±adidos: ['candidate_id', 'first_name', 'last_name', 'hire_date', 'salary_range', 'emergency_contact_name', 'emergency_contact_phone', 'notes', 'profile_photo', 'is_active', 'languages', 'certifications', 'performance_metrics', 'created_by', 'updated_by']
     * âŒ Campos removidos: ['name', 'active', 'max_candidates']
     * ðŸ“Š Total campos fillable: 20
     * 
    ...
    /**
     * Cache TTL por defecto para mÃ©tricas (5 minutos)
     */
    private const CACHE_TTL = 300;

    /**
     * LÃ­mite mÃ¡ximo de candidatos por recruiter por defecto
     */
     ...
     * 
     * Utiliza la vista vw_recruiter_load para obtener mÃ©tricas optimizadas
     * de candidatos activos asignados en los Ãºltimos 180 dÃ­as.
     * 
    ...
    /**
     * Obtener mÃ©tricas de rendimiento de un recruiter
     * 
     * Incluye estadÃ­sticas de candidatos procesados, entrevistas realizadas,
     ...
     * 
     * Filtra recruiters activos con capacidad disponible basÃ¡ndose en
     * su carga actual versus el mÃ¡ximo configurado.
     * 
     * @param int|null $departmentId Filtrar por departamento especÃ­fico
     ...
     * 
     * @param int|null $departmentId Balancear solo un departamento especÃ­fico
     * @return array Resultado del balanceo con estadÃ­sticas
     */
    public function balanceRecruiterWorkload(?int $departmentId = null): array
    {
        try {
            ...
            foreach ($overloaded as $overloadedRecruiter) {
                ...
                // Buscar candidatos mÃ¡s recientes para redistribuir
    ...
    /**
     * Obtener recruiter con menor carga para asignaciÃ³n automÃ¡tica
     * 
    ...
    /**
     * Asignar candidato a un recruiter especÃ­fico
     * 
     * @param int $candidateId ID del candidato
     * @param int $recruiterId ID del recruiter
     * @return bool Resultado de la asignaciÃ³n
     */
    ...
    /**
     * MÃ©todo auxiliar para ejecutar la query de estadÃ­sticas del recruiter
     */
    ...
    /**
     * Obtener candidatos recientes para redistribuciÃ³n
     */
    ...
    /**
     * Encontrar el mejor recruiter objetivo para redistribuciÃ³n
     */
     ...
     * @param array $filters Filtros de bÃºsqueda
     * @return int NÃºmero total de recruiters
     */
    ...
    /**
     * Validar datos especÃ­ficos de recruiters
    ...
    /**
     * Invalidar cache especÃ­fico de recruiters
     */
