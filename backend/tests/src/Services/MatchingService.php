 ...
 * usando OpenAI GPT-4 para análisis avanzado de compatibilidad.
 *
...
class MatchingService
{
    ...
    public function __construct()
    {
        ...
        if (!$this->apiKey) {
            throw new \Exception('OpenAI API key no configurada para MatchingService');
        }
    }
...
Responde ÚNICAMENTE con JSON válido en este formato exacto:
{
  ...
  "risk_factors": [
     ...
     */
    private function createFallbackScore($candidateData, $jobData)
    {
