...
// Script de debug para ver exactamente quÃƒÆ’Ã‚Â© se envÃƒÆ’Ã‚Â­a a Ollama
$_POST['filename'] = 'Ejemplo1_CV_2025-07-27_12-13-23.txt';

echo "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â DEBUG: Ãƒâ€šÃ‚Â¿QUÃƒÆ’Ã¢â‚¬Â° SE ENVÃƒÆ’Ã‚ÂA A OLLAMA?\n";
echo "==================================\n\n";
...
echo "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â  INFORMACIÃƒÆ’Ã¢â‚¬Å“N DEL PROMPT:\n";
echo "==========================\n";
echo 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â Longitud total: ' . strlen($prompt) . " caracteres\n";
echo "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Å¾ Archivo CV: $filename\n";
echo 'ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â¾ TamaÃƒÆ’Ã‚Â±o del contenido del CV: ' . strlen($content) . " caracteres\n\n";

echo "ÃƒÂ°Ã…Â¸Ã…Â¡Ã¢â€šÂ¬ PAYLOAD QUE SE ENVÃƒÆ’Ã‚ÂA A OLLAMA:\n";
echo "=================================\n";
...
echo "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â PRIMEROS 500 CARACTERES DEL PROMPT:\n";
echo "======================================\n";
echo substr($prompt, 0, 500) . "...\n\n";

echo "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â ÃƒÆ’Ã…Â¡LTIMOS 300 CARACTERES DEL PROMPT:\n";
echo "====================================\n";
echo '...' . substr($prompt, -300) . "\n\n";

echo "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ DEBUG COMPLETADO - READY PARA ENVIAR A OLLAMA\n";
