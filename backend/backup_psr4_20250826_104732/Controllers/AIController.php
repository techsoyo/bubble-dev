...
namespace Controllers\AIController.php\Controllers;
...
class AIController extends BaseController
{
    ...
    public function parseCVFromFile(Request $request, array $params = [])
    {
        ...
        // TODO: implementar lÃ³gica de parsing
    ...
    public function analyzePdfDirect(Request $request, array $params = [])
    {
        ...
        // TODO: lÃ³gica de anÃ¡lisis IA sobre PDF
    ...
    public function calculateMatching(Request $request, array $params = [])
    {
        ...
        if (!$candidateId || !$jobId) {
            return ResponseHelper::error('Faltan parÃ¡metros candidate_id o job_id', null, 400);
        }
        ...
        return ResponseHelper::success('Matching calculado (dev)', [
            ...
            'note' => 'Score mock para desarrollo - implementar IA en producciÃ³n'
        ]);
    }
    ...
    public function analyzePersonality(Request $request, array $params = [])
    {
        ...
        return ResponseHelper::success('AnÃ¡lisis de personalidad completado', [
    ...
    public function predictPerformance(Request $request, array $params = [])
    {
        ...
        return ResponseHelper::success('PredicciÃ³n completada', [
            'candidate_id' => $candidateId,
