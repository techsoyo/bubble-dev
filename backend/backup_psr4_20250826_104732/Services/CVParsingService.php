...
namespace Services\CVParsingService.php\Services;

/**
 * Servicio para el procesamiento bÃ¡sico de CVs (sin IA)
 * Se enfoca en extracciÃ³n de texto y generaciÃ³n de archivos para procesamiento posterior
 */
class CVParsingService
{
    /**
     * Servicio de extracciÃ³n de PDF
     ...
     * @return array InformaciÃ³n del procesamiento
     */
    ...
    /**
     * Extrae habilidades bÃ¡sicas del texto (sin IA)
     *
    ...
    {
        // Lista bÃ¡sica de habilidades comunes
        $commonSkills = [
          'php',
          'javascript',
          'python',
    ...
    private function saveTextFile($text, $originalFile)
    {
        ...
        // Guardar como JSON con metadatos (como ya lo hacÃ­as)
        $data = [
    ...
    /**
     * MÃ©todo legacy para mantener compatibilidad (DEPRECATED)
     * @deprecated Usar processCV
     */
    public function parseCV($cvText)
    {
        // Solo devolver habilidades bÃ¡sicas para mantener compatibilidad
        return [
          'skills' => $this->extractBasicSkills($cvText),
          'ai_enabled' => false,
          'message' => 'Usando extracciÃ³n bÃ¡sica - IA separada en mÃ³dulo independiente'
        ];
    }
