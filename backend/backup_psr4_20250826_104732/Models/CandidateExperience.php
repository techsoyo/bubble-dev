...
namespace Models\CandidateExperience.php\Models;
 ...
 * 
 * Este modelo maneja toda la informaciÃ³n relacionada con la experiencia laboral
 * de los candidatos, incluyendo posiciones actuales, historial profesional,
 * validaciones de fechas y anÃ¡lisis de experiencia.
 * 
 * @package Models
 * @version 2.0.0
 * @since 2025-08-25
...
class CandidateExperience extends BaseModel
{
    ...
    /**
     * MÃ‰TODOS PRINCIPALES DEL MODELO
     */

    /**
     * Obtiene el historial completo de experiencias de un candidato
     * ordenado por fecha de inicio (mÃ¡s reciente primero)
     */
    ...
    /**
     * Obtiene la posiciÃ³n actual del candidato
    ...
    /**
     * Obtiene todas las experiencias de un candidato en una empresa especÃ­fica
     */
    ...
    /**
     * Calcula la experiencia total del candidato en aÃ±os
    ...
    public function calculateTotalExperience(string $candidateId): array
    {
        ...
        // Convertir dÃ­as a aÃ±os, meses y dÃ­as
    ...
    /**
     * MÃ‰TODOS DE VALIDACIÃ“N Y ANÃLISIS
     */
    ...
    public function validateExperienceDates(array $data): array
    {
        ...
        // Validar que start_date estÃ© presente
        ...
        // Si no es posiciÃ³n actual, validar end_date
    ...
    /**
     * Valida que un candidato no tenga mÃºltiples posiciones actuales
     */
    ...
    /**
     * MÃ‰TODOS DE ANÃLISIS AVANZADO
     */
    ...
    public function analyzeJobStability(string $candidateId): array
    {
        ...
        if (count($experiences) < 2) {
            return [
                'stability_score' => 10, // MÃ¡xima estabilidad si tiene 1 o menos trabajos
        ...
        for ($i = 0; $i < count($experiences); $i++) {
            ...
            if ($i < count($experiences) - 1) {
                ...
                if ($startDate > $nextEndDate) {
                    ...
                    if ($gap > 30) { // Gap mayor a 30 dÃ­as
                        $gaps[] = [
                            'days' => $gap,
    ...
    /**
     * Obtiene recomendaciÃ³n basada en el anÃ¡lisis de estabilidad
     */
    ...
    /**
     * MÃ‰TODOS HEREDADOS Y ESPECÃFICOS
     */
    ...
    public function store(array $data)
    {
        ...
        // Validar posiciÃ³n Ãºnica actual
        if ($data['current'] ?? false) {
    ...
    public function update($id, array $data): bool
    {
        ...
        // Validar posiciÃ³n Ãºnica actual si se estÃ¡ marcando como actual
    ...
    /**
     * Obtiene estadÃ­sticas rÃ¡pidas de experiencia para un candidato
     */
