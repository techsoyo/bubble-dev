...
namespace Controllers\HealthController.php\Controllers;

/**
 * Health Check Controller
 *
 * Proporciona endpoints para verificar el estado del sistema
 * Implementa manejo robusto de errores y validaciÃ³n
 * 
 * @package Controllers
 * @version 2.0.0
 */
...
{
  /**
   * Comprueba si el servidor estÃ¡ funcionando correctamente
   * 
   * Este endpoint nunca debe fallar y siempre debe retornar una respuesta vÃ¡lida
   * 
   * @param array $params ParÃ¡metros de la ruta (no usados)
   * @return void
   */
  public function check($params = []): void
  {
    try {
      ...
      // InformaciÃ³n bÃ¡sica del sistema que siempre debe estar disponible
      $healthData = [
        'status' => 'healthy',
      ...
      // Verificar conexiÃ³n a la base de datos de forma segura
      try {
        ...
        // Error de base de datos no es crÃ­tico para health check
        $healthData['database'] = [
          'status' => 'disconnected',
      ...
      // Respuesta exitosa con toda la informaciÃ³n
      ...
      // Respuesta mÃ­nima de emergencia - NUNCA debe fallar
      try {
        ...
        // Respuesta de Ãºltimo recurso si todo falla
