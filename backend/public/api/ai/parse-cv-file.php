...
// ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Este código solo debe ejecutarse cuando el prompt del PASO 1 haya sido verificado.

$ollamaHost = 'http://localhost:11434';
$model = 'recruitment-ai'; // o el modelo que estés usando
...
// Verificar que Ollama respondió
$data = json_decode($response, true);
if (!isset($data['response'])) {
    echo json_encode(['error' => 'Respuesta inví¡lida de Ollama', 'raw' => $response]);
    exit;
}
